    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="/main1">{{ __('movie') }}</a></li>
                    <li><a href="/favorites" class="active">{{ __('favorite_movie') }}</a></li>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div class="card">
                            <div class="member-img">
                                <img src="{{ $favorite->poster }}" class="img-fluid" alt="Movie poster" loading="lazy">
                            </div>
                            <div class="card-body">
    ...
    <script>
        @if (session('success_delete_data'))
            swal({
                icon: 'success',
                title: 'Berhasil',
                text: 'Berhasil Menghapus Dari Favorite Movie',
