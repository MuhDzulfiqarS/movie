  ...
  <main class="main">
    <div class="page-title dark-background">
      <div class="container">
        <nav class="breadcrumbs">
          <ol>
            <li><a href="/main1">Movie</a></li>
            <li class="current">{{ __('detail_movie') }}</li>
          </ol>
        </nav>
        <h1>{{ __('detail_movie') }}</h1>
      </div>
    </div>
    ...
    <section id="portfolio-details" class="portfolio-details section">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-4">
          <div class="col-lg-8">
            <img src="{{ $movie['Poster'] }}" alt="{{ $movie['Title'] }}" class="portfolio-image">
          </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-description" data-aos="fade-up" data-aos-delay="300">
              ...
              <form method="POST" action="/favorites">
                ...
                <button type="submit" class="btn btn-success">{{ __('favorite') }}</button>
              </form>
            </div>
          </div>
        </div>
